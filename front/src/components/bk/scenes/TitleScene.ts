...
export class TitleScene extends Phaser.Scene {
  ...
  create() {
    ...
    // タイトルテキストを画面中央に表示
    this.add.text(this.cameras.main.centerX, 150, 'フレームワーク', titleStyle).setOrigin(0.5);
    ...
    // ゲームスタートボタン
    createButton('ゲームスタート', this.cameras.main.centerY - 100, () => this.scene.start('GameScene'));
    // オプションボタン
